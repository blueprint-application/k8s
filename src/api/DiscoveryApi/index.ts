...
export class DiscoveryApi extends BaseApi {
  async getDiscoveryAPIGroup(options?: Partial<AxiosRequestConfig>): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
    const url = this.buildUrl('/apis/discovery.k8s.io/');
