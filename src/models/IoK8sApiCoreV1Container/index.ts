...
import type { IoK8sApiCoreV1ContainerModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiCoreV1ContainerModel extends BaseModel {
  ...
  constructor(data: IoK8sApiCoreV1ContainerModelOptions) {
    super();
    validate(data);
    this.args = data.args;
  ...
  static create(data: IoK8sApiCoreV1ContainerModelOptions): IoK8sApiCoreV1ContainerModel {
    return new IoK8sApiCoreV1ContainerModel(data);
  }
...
export default IoK8sApiCoreV1ContainerModel;
