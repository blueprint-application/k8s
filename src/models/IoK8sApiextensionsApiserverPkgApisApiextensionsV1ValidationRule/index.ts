...
import type { IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModel extends BaseModel {
  ...
  constructor(data: IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModelOptions) {
    super();
    validate(data);
    this.fieldPath = data.fieldPath;
    this.message = data.message;
    this.messageExpression = data.messageExpression;
    this.optionalOldSelf = data.optionalOldSelf;
    this.reason = data.reason;
    this.rule = data.rule;
  }

  static create(
    data: IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModelOptions,
  ): IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModel {
    return new IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModel(data);
  }
  ...
  toObject(): Partial<this> {
    return {
      ...
      messageExpression: this.messageExpression,
      optionalOldSelf: this.optionalOldSelf,
      reason: this.reason,
      rule: this.rule,
    } as Partial<this>;
  }
...
export default IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRuleModel;
