...
import type { IoK8sApiCoreV1PodAffinityModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiCoreV1PodAffinityModel extends BaseModel {
  ...
  constructor(data: IoK8sApiCoreV1PodAffinityModelOptions) {
    super();
    validate(data);
  ...
  static create(data: IoK8sApiCoreV1PodAffinityModelOptions): IoK8sApiCoreV1PodAffinityModel {
    return new IoK8sApiCoreV1PodAffinityModel(data);
  }
...
export default IoK8sApiCoreV1PodAffinityModel;
