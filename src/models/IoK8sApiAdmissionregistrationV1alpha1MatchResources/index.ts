import { IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperationsModelOptions as IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperations } from '../IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperations';
...
import type { IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModel extends BaseModel {
  ...
  constructor(data: IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModelOptions,
  ): IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModel {
    return new IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModel(data);
  }
...
export default IoK8sApiAdmissionregistrationV1alpha1MatchResourcesModel;
