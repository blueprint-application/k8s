...
import type { IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModel extends BaseModel {
  ...
  constructor(data: IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModelOptions,
  ): IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModel {
    return new IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModel(data);
  }
...
export default IoK8sApiFlowcontrolV1LimitedPriorityLevelConfigurationModel;
