...
import type { IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModel extends BaseModel {
  ...
  constructor(data: IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModelOptions,
  ): IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModel {
    return new IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModel(data);
  }
...
export default IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpecModel;
