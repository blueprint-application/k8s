...
import type { IoK8sApiStorageV1CSIDriverSpecModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiStorageV1CSIDriverSpecModel extends BaseModel {
  ...
  constructor(data: IoK8sApiStorageV1CSIDriverSpecModelOptions) {
    super();
    validate(data);
    this.attachRequired = data.attachRequired;
    this.fsGroupPolicy = data.fsGroupPolicy;
    this.podInfoOnMount = data.podInfoOnMount;
    this.requiresRepublish = data.requiresRepublish;
    this.seLinuxMount = data.seLinuxMount;
    this.storageCapacity = data.storageCapacity;
    this.tokenRequests = data.tokenRequests;
    this.volumeLifecycleModes = data.volumeLifecycleModes;
  }

  static create(data: IoK8sApiStorageV1CSIDriverSpecModelOptions): IoK8sApiStorageV1CSIDriverSpecModel {
    return new IoK8sApiStorageV1CSIDriverSpecModel(data);
  }
...
export default IoK8sApiStorageV1CSIDriverSpecModel;
