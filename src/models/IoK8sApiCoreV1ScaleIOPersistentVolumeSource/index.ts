...
import type { IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModel extends BaseModel {
  ...
  constructor(data: IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModelOptions,
  ): IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModel {
    return new IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModel(data);
  }
...
export default IoK8sApiCoreV1ScaleIOPersistentVolumeSourceModel;
