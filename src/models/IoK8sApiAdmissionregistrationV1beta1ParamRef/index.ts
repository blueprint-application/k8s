...
import type { IoK8sApiAdmissionregistrationV1beta1ParamRefModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiAdmissionregistrationV1beta1ParamRefModel extends BaseModel {
  ...
  constructor(data: IoK8sApiAdmissionregistrationV1beta1ParamRefModelOptions) {
    super();
    validate(data);
    this.name = data.name;
  ...
  static create(
    data: IoK8sApiAdmissionregistrationV1beta1ParamRefModelOptions,
  ): IoK8sApiAdmissionregistrationV1beta1ParamRefModel {
    return new IoK8sApiAdmissionregistrationV1beta1ParamRefModel(data);
  }
...
export default IoK8sApiAdmissionregistrationV1beta1ParamRefModel;
