...
import type { IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModel extends BaseModel {
  ...
  constructor(data: IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModelOptions,
  ): IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModel {
    return new IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModel(data);
  }
...
export default IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicySpecModel;
