...
import type { IoK8sApiCoreV1ISCSIVolumeSourceModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiCoreV1ISCSIVolumeSourceModel extends BaseModel {
  ...
  constructor(data: IoK8sApiCoreV1ISCSIVolumeSourceModelOptions) {
    super();
    validate(data);
  ...
  static create(data: IoK8sApiCoreV1ISCSIVolumeSourceModelOptions): IoK8sApiCoreV1ISCSIVolumeSourceModel {
    return new IoK8sApiCoreV1ISCSIVolumeSourceModel(data);
  }
...
export default IoK8sApiCoreV1ISCSIVolumeSourceModel;
