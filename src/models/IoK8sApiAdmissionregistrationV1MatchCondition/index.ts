...
import type { IoK8sApiAdmissionregistrationV1MatchConditionModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiAdmissionregistrationV1MatchConditionModel extends BaseModel {
  ...
  constructor(data: IoK8sApiAdmissionregistrationV1MatchConditionModelOptions) {
    super();
    validate(data);
  ...
  static create(
    data: IoK8sApiAdmissionregistrationV1MatchConditionModelOptions,
  ): IoK8sApiAdmissionregistrationV1MatchConditionModel {
    return new IoK8sApiAdmissionregistrationV1MatchConditionModel(data);
  }
...
export default IoK8sApiAdmissionregistrationV1MatchConditionModel;
