...
import type { IoK8sApiCoreV1ServiceSpecModelOptions } from './types';
import { validate } from './validation';

export * from './types';

export class IoK8sApiCoreV1ServiceSpecModel extends BaseModel {
  ...
  constructor(data: IoK8sApiCoreV1ServiceSpecModelOptions) {
    super();
    validate(data);
    this.allocateLoadBalancerNodePorts = data.allocateLoadBalancerNodePorts;
    ...
    this.externalTrafficPolicy = data.externalTrafficPolicy;
    this.healthCheckNodePort = data.healthCheckNodePort;
    this.internalTrafficPolicy = data.internalTrafficPolicy;
    this.ipFamilies = data.ipFamilies;
    this.ipFamilyPolicy = data.ipFamilyPolicy;
    this.loadBalancerClass = data.loadBalancerClass;
    this.loadBalancerIP = data.loadBalancerIP;
    this.loadBalancerSourceRanges = data.loadBalancerSourceRanges;
    this.ports = data.ports;
    this.publishNotReadyAddresses = data.publishNotReadyAddresses;
    this.selector = data.selector;
    this.sessionAffinity = data.sessionAffinity;
    this.sessionAffinityConfig = data.sessionAffinityConfig;
    this.type = data.type;
  }

  static create(data: IoK8sApiCoreV1ServiceSpecModelOptions): IoK8sApiCoreV1ServiceSpecModel {
    return new IoK8sApiCoreV1ServiceSpecModel(data);
  }
...
export default IoK8sApiCoreV1ServiceSpecModel;
