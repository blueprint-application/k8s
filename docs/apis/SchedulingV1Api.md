...
> IoK8sApiSchedulingV1PriorityClass createSchedulingV1PriorityClass(body)
...
```typescript
import { SDK, CreateSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiSchedulingV1PriorityClass = await sdk.schedulingV1.createSchedulingV1PriorityClass(params)
...
[[Back to top]](SchedulingV1Api.md#schedulingv1api) [[Back to API list]](../apis.md#documentation) [[Back to Model list]](../models.md#documentation) [[Back to README]](../../readme.md)


## **deleteSchedulingV1CollectionPriorityClass**
> IoK8sApimachineryPkgApisMetaV1Status deleteSchedulingV1CollectionPriorityClass()
...
```typescript
import { SDK, DeleteSchedulingV1CollectionPriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.schedulingV1.deleteSchedulingV1CollectionPriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteSchedulingV1PriorityClass()
...
```typescript
import { SDK, DeleteSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.schedulingV1.deleteSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, GetSchedulingV1APIResourcesParams } from '';

const sdk = new SDK({ /* ... */ }); // or SDK.create({ /* ... */ });

async function someHandler () {
  const result: IoK8sApimachineryPkgApisMetaV1APIResourceList = await sdk.schedulingV1.getSchedulingV1APIResources()
}
```
...
> IoK8sApiSchedulingV1PriorityClassList listSchedulingV1PriorityClass()
...
```typescript
import { SDK, ListSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiSchedulingV1PriorityClassList = await sdk.schedulingV1.listSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiSchedulingV1PriorityClass patchSchedulingV1PriorityClass(body)
...
```typescript
import { SDK, PatchSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiSchedulingV1PriorityClass = await sdk.schedulingV1.patchSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiSchedulingV1PriorityClass readSchedulingV1PriorityClass()
...
```typescript
import { SDK, ReadSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiSchedulingV1PriorityClass = await sdk.schedulingV1.readSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiSchedulingV1PriorityClass replaceSchedulingV1PriorityClass(body)
...
```typescript
import { SDK, ReplaceSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiSchedulingV1PriorityClass = await sdk.schedulingV1.replaceSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchSchedulingV1PriorityClass()
...
```typescript
import { SDK, WatchSchedulingV1PriorityClassParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.schedulingV1.watchSchedulingV1PriorityClass(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchSchedulingV1PriorityClassList()
...
```typescript
import { SDK, WatchSchedulingV1PriorityClassListParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.schedulingV1.watchSchedulingV1PriorityClassList(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
