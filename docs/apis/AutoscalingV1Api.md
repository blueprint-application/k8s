...
> IoK8sApiAutoscalingV1HorizontalPodAutoscaler createAutoscalingV1NamespacedHorizontalPodAutoscaler(body)
...
```typescript
import { SDK, CreateAutoscalingV1NamespacedHorizontalPodAutoscalerParams } from '';
...
> IoK8sApimachineryPkgApisMetaV1Status deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.autoscalingV1.deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteAutoscalingV1NamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, DeleteAutoscalingV1NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.autoscalingV1.deleteAutoscalingV1NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, ListAutoscalingV1HorizontalPodAutoscalerForAllNamespacesParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV1HorizontalPodAutoscalerList = await sdk.autoscalingV1.listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV1HorizontalPodAutoscaler patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(body)
...
```typescript
import { SDK, PatchAutoscalingV1NamespacedHorizontalPodAutoscalerStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV1HorizontalPodAutoscaler = await sdk.autoscalingV1.patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV1HorizontalPodAutoscaler replaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(body)
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV1HorizontalPodAutoscaler = await sdk.autoscalingV1.replaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces()
...
```typescript
import { SDK, WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.autoscalingV1.watchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
