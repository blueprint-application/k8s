...
> IoK8sApiAuthenticationV1SelfSubjectReview createAuthenticationV1SelfSubjectReview(body)
...
```typescript
import { SDK, CreateAuthenticationV1SelfSubjectReviewParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAuthenticationV1SelfSubjectReview = await sdk.authenticationV1.createAuthenticationV1SelfSubjectReview(params)
...
[[Back to top]](AuthenticationV1Api.md#authenticationv1api) [[Back to API list]](../apis.md#documentation) [[Back to Model list]](../models.md#documentation) [[Back to README]](../../readme.md)


## **createAuthenticationV1TokenReview**
> IoK8sApiAuthenticationV1TokenReview createAuthenticationV1TokenReview(body)
...
```typescript
import { SDK, CreateAuthenticationV1TokenReviewParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAuthenticationV1TokenReview = await sdk.authenticationV1.createAuthenticationV1TokenReview(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, GetAuthenticationV1APIResourcesParams } from '';

const sdk = new SDK({ /* ... */ }); // or SDK.create({ /* ... */ });

async function someHandler () {
  const result: IoK8sApimachineryPkgApisMetaV1APIResourceList = await sdk.authenticationV1.getAuthenticationV1APIResources()
}
```
