...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler createAutoscalingV2NamespacedHorizontalPodAutoscaler(body)
...
```typescript
import { SDK, CreateAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.createAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
...
[[Back to top]](AutoscalingV2Api.md#autoscalingv2api) [[Back to API list]](../apis.md#documentation) [[Back to Model list]](../models.md#documentation) [[Back to README]](../../readme.md)


## **deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler**
> IoK8sApimachineryPkgApisMetaV1Status deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, DeleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.autoscalingV2.deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteAutoscalingV2NamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, DeleteAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.autoscalingV2.deleteAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, GetAutoscalingV2APIResourcesParams } from '';

const sdk = new SDK({ /* ... */ }); // or SDK.create({ /* ... */ });

async function someHandler () {
  const result: IoK8sApimachineryPkgApisMetaV1APIResourceList = await sdk.autoscalingV2.getAutoscalingV2APIResources()
}
```
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscalerList listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces()
...
```typescript
import { SDK, ListAutoscalingV2HorizontalPodAutoscalerForAllNamespacesParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscalerList = await sdk.autoscalingV2.listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscalerList listAutoscalingV2NamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, ListAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscalerList = await sdk.autoscalingV2.listAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler patchAutoscalingV2NamespacedHorizontalPodAutoscaler(body)
...
```typescript
import { SDK, PatchAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.patchAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(body)
...
```typescript
import { SDK, PatchAutoscalingV2NamespacedHorizontalPodAutoscalerStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler readAutoscalingV2NamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, ReadAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.readAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus()
...
```typescript
import { SDK, ReadAutoscalingV2NamespacedHorizontalPodAutoscalerStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler replaceAutoscalingV2NamespacedHorizontalPodAutoscaler(body)
...
```typescript
import { SDK, ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.replaceAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(body)
...
```typescript
import { SDK, ReplaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiAutoscalingV2HorizontalPodAutoscaler = await sdk.autoscalingV2.replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces()
...
```typescript
import { SDK, WatchAutoscalingV2HorizontalPodAutoscalerListForAllNamespacesParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.autoscalingV2.watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchAutoscalingV2NamespacedHorizontalPodAutoscaler()
...
```typescript
import { SDK, WatchAutoscalingV2NamespacedHorizontalPodAutoscalerParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.autoscalingV2.watchAutoscalingV2NamespacedHorizontalPodAutoscaler(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchAutoscalingV2NamespacedHorizontalPodAutoscalerList()
...
```typescript
import { SDK, WatchAutoscalingV2NamespacedHorizontalPodAutoscalerListParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.autoscalingV2.watchAutoscalingV2NamespacedHorizontalPodAutoscalerList(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
