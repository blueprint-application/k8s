...
```typescript
import { SDK, CreateApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.createApiextensionsV1CustomResourceDefinition(params)
...
[[Back to top]](ApiextensionsV1Api.md#apiextensionsv1api) [[Back to API list]](../apis.md#documentation) [[Back to Model list]](../models.md#documentation) [[Back to README]](../../readme.md)
...
```typescript
import { SDK, DeleteApiextensionsV1CollectionCustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.apiextensionsV1.deleteApiextensionsV1CollectionCustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, DeleteApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1Status = await sdk.apiextensionsV1.deleteApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, GetApiextensionsV1APIResourcesParams } from '';

const sdk = new SDK({ /* ... */ }); // or SDK.create({ /* ... */ });

async function someHandler () {
  const result: IoK8sApimachineryPkgApisMetaV1APIResourceList = await sdk.apiextensionsV1.getApiextensionsV1APIResources()
}
```
...
```typescript
import { SDK, ListApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList = await sdk.apiextensionsV1.listApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, PatchApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.patchApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, PatchApiextensionsV1CustomResourceDefinitionStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.patchApiextensionsV1CustomResourceDefinitionStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, ReadApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.readApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, ReadApiextensionsV1CustomResourceDefinitionStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.readApiextensionsV1CustomResourceDefinitionStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, ReplaceApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.replaceApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, ReplaceApiextensionsV1CustomResourceDefinitionStatusParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition = await sdk.apiextensionsV1.replaceApiextensionsV1CustomResourceDefinitionStatus(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, WatchApiextensionsV1CustomResourceDefinitionParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.apiextensionsV1.watchApiextensionsV1CustomResourceDefinition(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
...
```typescript
import { SDK, WatchApiextensionsV1CustomResourceDefinitionListParams } from '';
...
async function someHandler () {
  ...
  const result: IoK8sApimachineryPkgApisMetaV1WatchEvent = await sdk.apiextensionsV1.watchApiextensionsV1CustomResourceDefinitionList(params)
    .catch((error: AxiosError) => {
      console.error(error);
    });
  console.log(result);
